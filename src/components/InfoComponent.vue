  ...
  <div>
    <transition name="fade-menu">
      <div class="menu-buttons">
        ...
        <router-link to="/info" class="menu-btn">Products</router-link>
    ...
    <p>Here you will find information about activities that students are interested in, including details and how to participate in various activities.</p>
    <!-- You can add more content related to student activities here -->
  </div>
</template>
